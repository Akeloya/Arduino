...
namespace ArduinoEmulator.Commands
{
    ...
    {
        public static readonly RoutedCommand Close = new RoutedUICommand(nameof(Close), nameof(Close), typeof(Button), new InputGestureCollection { new KeyGesture(Key.Escape) });
    }
}
